...
//--	外部端口声明
//---------------------------------------------------------------------------
input					clk;				//时钟的端口,开发板用的100MHz晶振
input					rst_n;				//复位的端口,低电平复位
input		[ 4:0]		key_in;					//对应开发板上的key_in     EGO1有4个按键
...
assign		delay_done	=	(delay_cnt	==	100_000_000);          //等待复位1S后 按键开始工作

//设置定时器的时间为20ms
parameter SET_TIME_20MS = 27'd2_000_000_;	            // 计算：100M*(20/1000ms)=2_000_000
